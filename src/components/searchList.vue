<template>
    <div class="mainCont">
        <div class="searchHeader" >
            ...
            <div>
              <span v-if="$store.state.oneway.origin">{{getOrigin("oneway")}} > </span>
              <span> {{getDest("oneway")}} </span>
              <span v-if="isReturn"> > {{getDest("twoway")}}</span>
            </div>
            <div class="filghtTiming">
                <div v-if="$store.state.oneway.origin">Depart : {{getDate("oneway")}}</div>
